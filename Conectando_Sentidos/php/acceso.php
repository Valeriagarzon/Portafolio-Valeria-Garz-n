...
switch ($accion) {
    case 1:
        ...
        $sql = "INSERT INTO usuarios (nombre, apellidos, correo, contraseña, profesion) VALUES (?, ?, ?, ?, ?)";
    ...
    case 2:
        $email = $_POST['email'];
        $password = $_POST['pass'];
        $sql = "SELECT contraseña, profesion FROM usuarios WHERE correo = '$email'";
